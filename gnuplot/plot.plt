...
plot "test.dat" using 1:2 notitle with linespoints,\
     ...
     "test.dat" using 1:5 notitle with linespoints,\
     "test.dat" using 1:5 title "RM" with lines,\
     "test.dat" using 1:6 notitle with linespoints,\
     "test.dat" using 1:6 title "CP" with lines
